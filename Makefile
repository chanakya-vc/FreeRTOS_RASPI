...
kernel.elf: LDFLAGS += -L "/home/vc/Hyperloop/gcc-arm-none-eabi-6-2017-q1-update/lib/gcc/arm-none-eabi/6.3.1" -lgcc
kernel.elf: LDFLAGS += -L "/home/vc/Hyperloop/gcc-arm-none-eabi-6-2017-q1-update/arm-none-eabi/lib" -lc
kernel.elf: $(OBJECTS)
